...
import { Direction, oppositeDir } from "../src/direction.js";
...
import Position, { isInside, move, posEqual } from "../src/position.js";
...
export default class TwentyFortyEightGame extends GameBase {
	...
	constructor() {
		...
		for (let y = 0; y < HEIGHT; y++)
			for (let x = 0; x < WIDTH; x++) this.gameBoard[y * WIDTH + x] = 0;
